...
{
    /// <summary>
    /// Provides information and methods regarding the current media request.
    /// </summary>
    internal struct MediaContext
    {
        ...
        /// <param name="contentType">The media file content type.</param>
        /// <param name="maxAge">The max age representing the CacheControlMaxAge header.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        public Task SendStatusAsync(int statusCode, string contentType, TimeSpan maxAge)
        ...
        /// <param name="maxAge">The max age representing the CacheControlMaxAge header.</param>
        /// <returns>The <see cref="Task"/>.</returns>
        public async Task SendAsync(Stream stream, string contentType, TimeSpan maxAge)
        {
        ...
        private Task ApplyResponseHeadersAsync(
            int statusCode,
            string contentType,
            TimeSpan maxAge)
        {
            ...
            if (statusCode < 400)
            {
                ...
                // TODO: Async Event for OnPrepareResponse using context?
            }
            ...
            // Dummy return until we have events.
